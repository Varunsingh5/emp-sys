...
const notificationMessages = {
  info: "<span className='body-2'>Info:</span> This alert needs your attention, but it's not important.",
  warning: "<span className='body-2'>Warning:</span> Best check yourself, you're not looking too good.",
  success: "<span className='body-2'>Success:</span> You successfully read this important alert message.",
  error: "<span className='body-2'>Danger:</span> Danger: Change this and that and try again.",
}
